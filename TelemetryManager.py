...
class TelemetryManager():
    ...
    def __init__(self,active_vessel,krpc_connection):
        ...
        if self.vessel and self.conn:
            ...
            self.available_resources=self.resources.names() #list of stored resources
    ...
    def set_up_telemetry_streams(self):
        ...
        self.resource_telemetry_callback={name:(self.resources.amount, name)
                                        for name in self.available_resources}
        ...
        self.orbit_telemetry_stream={name:self.conn.add_stream(getattr,obj,attr) 
                                     for name,(obj,attr)in self.resource_telemetry_callback.items()}
